...
class Particle:
    def __init__(self, queens, score, board):
        ...
        self.c1 = 0.4 # 40% de chance de mover em direção ao máximo global  
        self.c2 = 0.2 # 20% de chance de mover em direção ao máximo local
    ...
    def show_particle(self):        
        ...
        show_dominated_board(self.local_max_queens)
